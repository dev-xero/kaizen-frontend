...
export default function MyTasks() {
    return (
        <section className="my-4 font-[family-name:var(--font-geist-sans)]">
            <h2 className="font-bold text-xl sm:text-2xl my-2 flex items-center gap-2 text-[#12111A] dark:text-indigo-100">
                <FolderOpen size={32} className="sm:w-8 w-6" />
                <span>My Tasks</span>
            </h2>
            <p className="text-gray-700 text-base sm:text-lg sm:mt-2 dark:text-gray-400">
